...
Pre-print version at [[https://arxiv.org/abs/2506.23822]](https://arxiv.org/pdf/2506.23822)
...
To reproduce accuracy results from the paper: edit the directories to match your local machine in `load_OP.py` and set `hparams['dataset']` accordingly. Then simply run `python main_OP.py`. Furthermore, all hyperparameters related to the datasets are provided in the `load_OP.py` and all hyperparameters can be modified.
